...
<head>
	...
	<style type="text/css">
		...
		.list_employe ul li:hover{
			background:url(images/flech.png) transparent no-repeat; background-position: 460px 98px; background-size:20% 20%;
		}
					...
					<div class="list_employe" id="list_employe" align="left">
						...
						<ul align="left" >
							...
							<li align="left" >
								...
								<span class="nom_emp" align="left" style="padding:5px 20px;"><?php $emp_name[i]=$myrowEmploye[EmployeName]; print($myrowEmploye[EmployeName]);?></span><br/><br/>
								<span class="contact_num" style="font-size:8px;"><? echo Poste; ?> : <?php $emp_Poste[i]=$myrowEmploye[EmployePoste]; print($myrowEmploye[EmployePoste]);?><br/></span>
								<span class="contact_num" style="font-size:8px;"><? echo Tel; ?> : <?php $emp_NumTel[i]=$myrowEmploye[EmployeNumTel]; print($myrowEmploye[EmployeNumTel]);?><br/></span>
								<span class="contact_num" style="font-size:8px;"><? echo Email; ?> : <?php $emp_Mail[i]=$myrowEmploye[EmployeMail]; print($myrowEmploye[EmployeMail]);?><br/></span>
								
								<a class="" href="javascript:showDiv();"><span class="detail">Detail</span></a>
...
<div id="popDiv" style="z-index:10001; display:none; position:fixed;  background-color:#FFF; top:50px; left:350px;">
	...
	<div id="intro_pers" style="width:700px; height:500px; overflow-y:scroll;">
		<? //echo $i;?>
		<div style="width:700px; height:500px;">
			<div style="width:650px; height:280px; margin-left:20px; border-bottom:3px #999999 solid;">
				<img class="icon_employe" src="<?php print($emp_ImgPath2[i]);?>" style="margin:30px; margin-right:0; width:380px; height:180px;"/> 
				<div style="float:right; margin:30px; margin-left:0; margin-right:30px;">
					<span class="nom_emp1" align="left" style="padding:5px 20px; font-size:20px;"><strong><?php print($emp_name[i]);?></strong></span><br/><br/>
					<span class="contact_num" style="font-size:8px;"><? echo Poste; ?> : <?php print($emp_Poste[i]);?><br/></span>
					<span class="contact_num" style="font-size:8px;"><? echo Tel; ?> : <?php print($emp_NumTel[i]);?><br/></span>
					<span class="contact_num" style="font-size:8px;"><? echo Email; ?> : <?php print($emp_Mail[i]);?><br/></span>
				</div>
			</div>
			<div style="margin:30px; margin-top:20px;">
			<span class="contact_num" style="font-size:8px; "><?php print($emp_Intro[i]);?><br/></span>
			</div>
		</div>
	</div>
...
<div id="popDiv" style="z-index:10001; display:none; position:fixed;  background-color:#FFF; top:50px; left:350px;">
	...
	<div style="width:700px; height:500px; overflow-y:scroll;">
		<?php 							
			...
			$Employe_sql2="select * from $tb_listemployes where `EmployeCheck`= '1' && `EmployeName` like '%".$searchpers."%' order by `EmployeID`";	
			$Employe_result2=mysql_query($Employe_sql2)OR die (mysql_error());*/
		
			//$i=0;
			//while($myrowEmploye=mysql_fetch_array($Employe_result2)){			
			?>
		<div style="width:650px; height:280px; margin-left:20px; border-bottom:3px #999999 solid;">
			<img class="icon_employe" src="<?php print($myrowEmploye[EmployeImgPath2]);?>" style="margin:30px; margin-right:0; width:380px; height:180px;"/> 
			<div style="float:right; margin:30px; margin-left:0; margin-right:30px;">
				<span class="nom_emp1" align="left" style="padding:5px 20px; font-size:20px;"><strong><?php print($myrowEmploye[EmployeName]);?></strong></span><br/><br/>
				<span class="contact_num" style="font-size:8px;"><? echo Poste; ?> : <?php print($myrowEmploye[EmployePoste]);?><br/></span>
				<span class="contact_num" style="font-size:8px;"><? echo Tel; ?> : <?php print($myrowEmploye[EmployeNumTel]);?><br/></span>
				<span class="contact_num" style="font-size:8px;"><? echo Email; ?> : <?php print($myrowEmploye[EmployeMail]);?><br/></span>
			</div>
		</div>
		<div style="margin:30px; margin-top:20px;">
		<span class="contact_num" style="font-size:8px; "><?php print($myrowEmploye[EmployeIntro]);?><br/></span>
		</div>
		<?php 
			//} 
			?>
